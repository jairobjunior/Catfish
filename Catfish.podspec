#
#  Be sure to run `pod spec lint Catfish.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Catfish"
  s.version      = "0.0.1"
  s.summary      = "A short description of Catfish."

  s.description  = <<-DESC
                   A longer description of Catfish in Markdown format.
  ...
  # s.authors      = { "Jairo Junior" => "jairobjunior@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'Jairo Junior', 'other author'
